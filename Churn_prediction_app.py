...
feature_names =  ['CreditScore', 'Age', 'Tenure', 'Balance', 'NumOfProducts', 'EstimatedSalary', 'HasCrCard_0.0', 'HasCrCard_1.0', 'IsActiveMember_0.0', 'IsActiveMember_1.0', 'Geography_France', 'Geography_Germany', 'Geography_Spain', 'Gender_Female', 'Gender_Male']
...
#App Header
st.image("Pic 2.jpg",use_container_width=True)
